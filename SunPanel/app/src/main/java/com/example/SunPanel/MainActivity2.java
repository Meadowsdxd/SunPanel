...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userFilter = (EditText)findViewById(R.id.userFilter2);
        search();
    ...
    public void onResume() {
        ...
        try {
            ...
            String[] headers = new String[]{DataBaseHelper.COLUMN_NAMEC, DataBaseHelper.COLUMN_KOLOVO,DataBaseHelper.COLUMN_KPDOBSH};
    ...
    public void add(View view){
        Intent intent = new Intent(this, ADDPanel.class);
        startActivity(intent);
    }
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                if (position==0){
                    ...
                    idd=DataBaseHelper.COLUMN_KOLOVO;

                }else if (position==2){
                    idd=DataBaseHelper.COLUMN_TEMPEND;
